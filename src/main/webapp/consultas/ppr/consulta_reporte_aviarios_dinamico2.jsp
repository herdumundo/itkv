...
<%    clases.controles.VerificarConexion();
    ...
    String iddesde= request.getParameter("iddesde2") ;
    String idhasta= request.getParameter("idhasta2") ;
    String tipoConsulta= request.getParameter("tipor2") ;
     String tipo_grafico2= request.getParameter("tipo_grafico2") ;
    String[] array_aviarios= request.getParameterValues("aaviarios2");
    String[] array_categoria= request.getParameterValues("ccategoria2");
    ...
    for(int i=0; i<array_categoria.length; i++)   
    {
      ...
      + "where vis.aviario IN  ("+aviario+")  and vis.fecha BETWEEN '"+iddesde+"' and '"+idhasta+"' "
   ...
   if(tipoConsulta.equals("promedio"))
   {
        query="SELECT  FORMAT(vis.fecha,'dd-MM')fecha,SUM(vis.muertes) as muerte,CONVERT(NUMERIC(10,1),round( avg(vis.muertes),0)) AS muertes,"
              ...
              + " where vis.aviario IN  ("+aviario+")   and vis.fecha BETWEEN '"+iddesde+"' and '"+idhasta+"' group by vis.fecha"
     ...
     if(tipoConsulta.equals("maximo"))
   {
      query="SELECT  FORMAT(vis.fecha,'dd-MM')fecha,MAX(vis.muertes) as muertes, "
              ...
              + "FROM vis_mae_ppr_grafico vis inner join vis_mae_huevos_aviarios con on  vis.aviario=con.aviario and  vis.fecha= con.fecha   "
              + "where vis.aviario IN  ("+aviario+")  and vis.fecha   BETWEEN '"+iddesde+"' and '"+idhasta+"' group by vis.fecha ORDER BY vis.fecha asc";
    };
    ...
    ResultSet rs=pt.executeQuery();
        ...
        JSONArray   categories,             Dataset,            contenido_subcategorias, 
            ...
            while(rs.next()) // va a recorrer 22 veces
            {
                    ...
                    DataMortandad.put("type",tipo_grafico2);
                    ...
                    DataHuevo.put("type",tipo_grafico2);
                    ...
                    DataAgua.put("type",  tipo_grafico2);
                    ...
                    DataTempMax.put("type",  tipo_grafico2);
                    ...
                    DataProducto.put("type",  tipo_grafico2);
                    ...
                    DataPadProdu.put("type",  tipo_grafico2);
                    ...
                    DataPadBalan.put("type",  tipo_grafico2);
                   ...
                   { 
                    ...
                    total_huevos=total_huevos+rs.getInt("huevocontador");
        ...
        clases.controles.DesconnectarBDsession();             
             ...
             charts.put("total_huevos", total_huevos); 
