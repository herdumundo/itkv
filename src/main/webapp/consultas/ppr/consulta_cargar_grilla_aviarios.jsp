...
<%@page import="java.util.*" %>
  <% 
    ...
    PreparedStatement pt=clases.controles.connectSesion.prepareStatement("exec stp_mae_ppr_select_contadores  @fecha_desde='"+fecha1+"',@fecha_hasta='"+fecha2+"',@aviario='"+aviario+"'");
