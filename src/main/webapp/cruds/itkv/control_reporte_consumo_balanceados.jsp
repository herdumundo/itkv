...
<%
     try 
    {
        ...
        {
             File reportfile = new File(application.getRealPath("reportes/itkv/insumos_consumo_balanceados.jasper"));
            ...
            response.setHeader("Content-Disposition", "inline; filename=Consumo_balanceados_nro_"+id+".pdf");
