...
<div class="col-lg-20 ">
    <div class="position-relative p-3 bg-navy"  >
        ...
        <center><b>REGISTRO DE GASTOS DE COMBUSTIBLES</b></center>
    </div>
</div> 
...
<form id="form_add_consumo" method="post" class="  bg-black"  >
    ...
    <input type="text" class="form-control autoNumeric" placeholder="Ingrese litros cargados"  required id="lt_total">
